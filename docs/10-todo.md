...
5. ~~**Theme editor GUI**~~ — ✅ done, see below.
...
Everything below the High-effort tier is now done (see 10.0 above). What's left is the program launcher, the plugin system, and split panes - each a bigger, more cross-cutting architecture change than the last.
